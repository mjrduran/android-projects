...
/**
 * Created by moacir.ramos on 07/04/17.
 */
...
public class MyCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView urlView = (TextView) view.findViewById(R.id.history_url);
        String url = cursor.getString(1); //Browser.HISTORY_PROJECTION_URL_INDEX
        urlView.setText(url);
...
//        }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return cursorInflater.inflate(R.layout.history_item, parent, false);
    }
